...
Development: https://github.com/jupyter/jupyter_client
...
<table><tr>
    <td>All platforms:</td>
    <td>
      <a href="https://github.com/conda-forge/jupyter_client-feedstock/actions/workflows/conda-build.yml">
        <img src="https://github.com/conda-forge/jupyter_client-feedstock/actions/workflows/conda-build.yml/badge.svg?event=push&branch=main">
      </a>
    </td>
  </tr>
</table>
...
pixi add jupyter_client
# for installing globally
pixi global install jupyter_client
```
...
It is possible to list all of the versions of `jupyter_client` available on your platform:
...
```
mamba search jupyter_client --channel conda-forge
```
...
```
pixi search jupyter_client --channel conda-forge
```
...
mamba repoquery search jupyter_client --channel conda-forge

# List packages depending on `jupyter_client`:
mamba repoquery whoneeds jupyter_client --channel conda-forge

# List dependencies of `jupyter_client`:
mamba repoquery depends jupyter_client --channel conda-forge
```
