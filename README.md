...
Once the `conda-forge` channel has been enabled, `jupyter_client` can be installed with `conda`:
...
It is possible to list all of the versions of `jupyter_client` available on your platform with `conda`:
